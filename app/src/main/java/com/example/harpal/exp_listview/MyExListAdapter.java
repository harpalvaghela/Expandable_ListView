...
/**
 * Created by Harpal on 05-Nov-18.
 */
...
public class MyExListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView textParent=(TextView)convertView.findViewById(R.id.txtParent);
        textParent.setText(langs);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView textChild=(TextView)convertView.findViewById(R.id.txtChild);
        textChild.setText(topics);
